...
export default function DashboardPage() {
  const { meta, resumo, lancamentos, definirMeta, adicionarLancamento, removerLancamento, resetar } = useMeta()
        ...
        <div className="flex items-start justify-between">
          <div>
            <p className="text-xs text-zinc-400 uppercase tracking-widest mb-1">
              {LABELS_TIPO[meta.userId as any] ?? 'Autônomo'} · {MESES[meta.mes - 1]} {meta.ano}
            </p>
